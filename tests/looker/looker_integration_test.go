...
func TestLooker(t *testing.T) {
	...
	tests.RunMCPToolInvokeParametersTest(t, "project_git_branch", []byte(fmt.Sprintf(`{"operation": "create", "project_id": "the_look", "branch": "test_branch_%s"}`, randstr)), wantResult)

	time.Sleep(5 * time.Second)
	wantResult = "d2d4eafdf8932837b2a12b773282c165a43fb0c0"
	tests.RunMCPToolInvokeParametersTest(t, "project_git_branch", []byte(fmt.Sprintf(`{"operation": "switch", "project_id": "the_look", "branch": "test_branch_%s", "ref": "d2d4eafdf8932837b2a12b773282c165a43fb0c0"}`, randstr)), wantResult)
	...
	wantResult = "Deleted"
	tests.RunMCPToolInvokeParametersTest(t, "project_git_branch", []byte(fmt.Sprintf(`{"operation": "delete", "project_id": "the_look", "branch": "test_branch_%s"}`, randstr)), wantResult)
