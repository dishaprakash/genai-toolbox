...
func TestPostgres(t *testing.T) {
	...
	tests.RunMCPPostgresListTablesTest(t, tableNameParam, tableNameAuth, PostgresUser)
	tests.RunMCPPostgresListViewsTest(t, ctx, pool)
	tests.RunMCPPostgresListSchemasTest(t, ctx, pool, PostgresUser, uniqueID)
